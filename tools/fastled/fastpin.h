...
#else // if !defined(FASTLED_NO_PINMAP)


#endif // if !defined(FASTLED_NO_PINMAP)
...
#else // ifdef FASTLED_FORCE_SOFTWARE_PINS
...
#endif // ifdef FASTLED_FORCE_SOFTWARE_PINS
...
#define _FL_DEFINE_PORT(L, BASE) \
    template <> struct __FL_PORT_INFO<L> { static bool hasPort(){ return 1; } \
...
#define _FL_DEFINE_PORT3(L, LC, BASE) \
    template <> struct __FL_PORT_INFO<LC> { static bool hasPort(){ return 1; } \
                                            static const char* portName(){ return #L; } \
                                            typedef BASE __t_baseType;  \
                                            static const void* portAddr(){ return (void*) &__t_baseType::r(); } };
